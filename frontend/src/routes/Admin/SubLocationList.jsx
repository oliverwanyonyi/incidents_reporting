...
async function deleteHandler(itemId) {
  await axiosPrivate.delete(`/counties/sub/${itemId}/delete`);
...
try {
  ...
  setLoading(true)
  const {data}  = await axiosPrivate.get(`/counties/${countyId}/sublocations?page=${currentPage}`)

  setData(data?.subLocations)
      ...
      <div className="admin-page-header">
        <div>
          <Link
            ...
            to={`/admin/${countyId}/sublocation/add`}
          >
            Add Sublocation
